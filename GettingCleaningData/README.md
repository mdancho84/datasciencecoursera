...
* `average_by_activity_subject.txt`: This is the output once the `run_analysis.R` script is run. The data is a tidy dataset with averages by activity and subject ID.
